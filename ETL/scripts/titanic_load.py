...
def load_titanic_to_supabase(staged_path, table_name="titanic_data"):
    ...
    for i in range(0, total_rows, batch_size):
        ...
        try:
            ...
            print(f"Batch error at batch {i // batch_size + 1}: {e}")
    print("Titanic upload complete!")

# Main Execution
if __name__ == "__main__":
    base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    staged_csv = os.path.join(base_dir, "data", "staged", "titanic_transformed.csv")
    load_titanic_to_supabase(staged_csv)